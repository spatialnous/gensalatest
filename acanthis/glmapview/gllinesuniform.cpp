...
void GLLinesUniform::loadLineData(const std::vector<SimpleLine> &lines,
...
void GLLinesUniform::initializeGL(bool coreProfile) {
    ...
    m_program->addShaderFromSourceCode(
        QOpenGLShader::Vertex, coreProfile ? vertexShaderSourceCore : vertexShaderSource);
    m_program->addShaderFromSourceCode(QOpenGLShader::Fragment,
                                       coreProfile ? fragmentShaderSourceCore
...
void GLLinesUniform::updateColour(const QColor &lineColour) {
    m_colour.setX(lineColour.redF());
    m_colour.setY(lineColour.greenF());
    m_colour.setZ(lineColour.blueF());
    m_program->bind();
