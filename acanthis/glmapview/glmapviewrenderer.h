...
class GLMapView;
class GLMapViewRenderer : public QQuickFramebufferObject::Renderer {
  ...
  public:
    GLMapViewRenderer(const QQuickFramebufferObject *item, const GraphDocument *pDoc,
